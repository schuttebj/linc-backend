    ...
    def create_person(self, person_data: PersonCreate, created_by: str = None) -> PersonResponse:
        ...
        try:
            ...
            db_person = Person(
                ...
                home_phone=person_data.home_phone,
                work_phone=person_data.work_phone,
                cell_phone_country_code=person_data.cell_phone_country_code,
                cell_phone=person_data.cell_phone,
                fax_phone=person_data.fax_phone,
